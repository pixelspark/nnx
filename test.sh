...
./target/release/nnx infer ./data/tymnist-inferred.onnx ./data/mnist-7.png --compare
./target/release/nnx infer ./data/tymnist-inferred.onnx ./data/mnist-5.jpg --compare
